<?php include "header.php"; ?>
    <main>
        ...
        <div class="center-wrapper">
            <a href="media/quote.pdf" download="Service Quote">
            <img src="media/quote.jpg" alt="quote" id="quote"></a>
            <a href="media/quote.pdf" download="Service Quote"><figcaption id="quote-caption"><svg class="icon-pdf"><use xlink:href="#icon-file-pdf"></use></svg>Download the PDF</figcaption>
            </a>
        </div>
    </main> 
